...
screen.title("QR-code Maker V2  -  Dr.M-Dev")
#+++++++++++++
...
if qr_type == "2" or qr_type == "file":
    ...
    while not directory_set:
        try:
            file_directory = screen.textinput(title="Input Text-File", prompt=r"Paste text file directory here (name & extension included),"
                                                                              r"\nEXAMPLE:\n[C:\\Users\\Name\Downloads\\file.txt]")
